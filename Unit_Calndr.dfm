object Form_Calndr: TForm_Calndr
  Left = 321
  Top = 47
  Width = 800
  Height = 700
  ...
  object PlannerMonthView1: TPlannerMonthView
    ...
    CaptionHoverColor = clNavy
    CaptionFont.Charset = RUSSIAN_CHARSET
    CaptionFont.Color = clBlack
    CaptionFont.Height = -13
    CaptionFont.Name = 'Comic Sans MS'
    ...
    DayFont.Height = -13
    DayFont.Name = 'Comic Sans MS'
    DayFont.Style = [fsBold]
    DefaultItem.AllowOverlap = False
    DefaultItem.BorderColor = clWhite
    DefaultItem.CaptionBkg = clLime
    DefaultItem.CaptionBkgTo = clYellow
    ...
    DefaultItem.SelectColor = clGreen
    DefaultItem.SelectColorTo = clMaroon
    ...
    Year = 2011
    Version = '3.0.0.1'
    OnItemDblClick = PlannerMonthView1ItemDblClick
    OnDaySelect = PlannerMonthView1DaySelect
    OnDateChange = PlannerMonthView1DateChange
  end
end
